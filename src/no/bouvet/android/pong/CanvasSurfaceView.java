...
public class CanvasSurfaceView extends SurfaceView {
    ...
    class CanvasThread extends Thread {
        ...
        CanvasThread(SurfaceHolder holder, FrameRenderer renderer) {
            super();
            mDone = false;
            mWidth = 0;
            mHeight = 0;
        ...
        public void run() {
             ...
             * asked to quit.
             */
            final ProfileRecorder profiler = new ProfileRecorder();
            final ProfileLogger profileLogger = new ProfileLogger(profiler);
            while (!mDone) {
